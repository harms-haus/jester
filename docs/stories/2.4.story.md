...
3. **Draft file naming** follows patterns: context-{number}.md, outline-{number}.md, story-{number}.md, entities-{number}/
4. **Entity naming in drafts** uses new-{type}-{descriptive-name}.md format in entities-{number}/ directories
...
- Entities: entities-{number}/ with new-{type}-{descriptive-name}.md
...
- Draft entities: new-{type}-{descriptive-name}.md
...
- [ ] 3.4. Create entities-{number}/ directory naming
- [ ] 3.5. Create new-{type}-{descriptive-name}.md entity naming
