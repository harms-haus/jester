...
8. **Template-based initialization** creates `.memory/target-audience-profiles.yaml` from `.jester/templates/memory/target-audience-profiles.yaml` if it doesn't exist
...
- `.jester/templates/memory/target-audience-profiles.yaml` - Profile template (already created)

**Modified Files**:
- `.jester/agents/jester.md` - Add audience management commands
- `.jester/templates/context.yaml` - Add target audience placeholders
