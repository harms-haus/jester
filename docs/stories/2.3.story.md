...
7. **Draft entity management** creates and manages entities in draft/entities-{draft-number}/ directory with new-{type}-{descriptive-name}.md naming convention
8. **Draft workflow support** maintains draft number consistency across context-{number}.md, outline-{number}.md, story-{number}.md, and entities-{number}/ files
...
- `/edit import story <file-path>` - Import and update single story file to fit current knowledge base entities
- `/edit import story <directory-path>` - Import and update multiple story files (up to 10 files) to fit current knowledge base
- `/edit import story <file-path> [template-type]` - Import story with specific template compliance (heroes_journey, pixar, golden_circle)
...
- Create entities in draft/entities-{draft-number}/ directory
- Use new-{type}-{descriptive-name}.md naming convention
- Maintain draft number consistency across all files
...
- [ ] 8.2. Define rules for new-{type}-{descriptive-name}.md naming convention
