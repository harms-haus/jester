...
**Files Created**:
- `draft/context-{draft_number}.md` - Your story context and requirements
- `draft/outline-{draft_number}.md` - Will be created when you're ready
- `draft/story-{draft_number}.md` - Will be created when you're ready
